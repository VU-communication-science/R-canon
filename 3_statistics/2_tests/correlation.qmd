...
In this tutorial we focus on conducting the test. For more details on the concept of correlation and how to interpret the correlation coefficient $r$, see the [covariance and correlation](../0_concepts/covariance-and-correlation.qmd) section.
...
For more detail on this, see the [causality](../0_concepts/causality.qmd) section.
