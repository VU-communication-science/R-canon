...
In those cases, where we only have **observational data** (e.g., surveys, interviews, content analysis), we therefore have to rely on **statistical methods** to control for confounding variables and establish causation.

### The next best thing: controlling for confounders

Using **statistical methods**, such as multiple regression, we can try to control for confounding variables.
