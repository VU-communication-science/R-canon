...
You could test these hypotheses separately with a correlation test and a t-test, respectively.
...
* The coefficient for `age` tells us how much `trust_t1` changes for every *unit increase* in `age`.
  ...
  * The p-value of `.210` tells us that this effect is not statistically.
