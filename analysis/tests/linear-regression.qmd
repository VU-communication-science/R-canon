...
Here we'll give a brief overview of the main concepts.
In **simple linear regression** have a dependent variable `Y` and an independent variable `X`, and we want to predict `Y` based on `X`.
