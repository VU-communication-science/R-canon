...
So we can test if the effect of `political_orientation` on `trust_t1` depends on `political_interest`.
We then also say that `political_interest` **moderates** the effect of `political_orientation` on `trust_t1`.
...
* Unstandardized coefficients:
  ...
  * This doesn't really make sense, because `political_interest` is measured on a scale from 1 to 7.
* Standardized coefficients:
