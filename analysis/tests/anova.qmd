...
Analysis of Variance, or ANOVA, is a statistical technique used to compare the means of several groups at once. ANOVA tests whether any of the group means differ more than would be expected by random variation alone.
