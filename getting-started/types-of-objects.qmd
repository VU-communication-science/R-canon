...
You can for instance perform a statistical test to see if the average height differs between countries.

And just like with single values and vectors, we need to take the type of each column into account.
